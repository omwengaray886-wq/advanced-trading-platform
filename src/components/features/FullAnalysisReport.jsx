    ...
    return (
        ...
        >
            <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
                        ...
                        {setups.map(setup => (
                            ...
                            >
                                ...
                                <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                                    ...
                                    <p style={{ fontSize: '12px', color: 'var(--color-text-secondary)', lineHeight: '1.5', italic: 'true' }}>
                                        "{setup.rationale}"
                                    </p>

                                    <footer style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', pt: '12px', borderTop: '1px solid var(--color-border-subtle)' }}>
                                        <span style={{
                                            fontSize: '10px',
                                            padding: '4px 8px',
                                            borderRadius: '4px',
                                        ...
                                        <span style={{ fontSize: '11px', color: setup.direction === 'LONG' ? 'var(--color-success)' : 'var(--color-danger)', fontWeight: 'bold' }}>
                                            HTF CONFLUENCE: {analysis.marketState.mtf?.globalBias}
                                        </span>
                                    </footer>
                                </div>
                            </div>
                ...
                <footer style={{ marginTop: '64px', pt: '32px', borderTop: '1px solid var(--color-border-subtle)', textAlign: 'center', opacity: 0.6, fontSize: '12px' }}>
                    <p>Institutional AI Trading Environment • Analysis generated on {new Date(analysis.timestamp).toLocaleString()}</p>
